...
fn jw_two_elec_02() {
    jw_check_mapping(
        &[(4.0, Fermions::try_from((0, 32, 32, 0)).unwrap())],
        &[
            (1.0, Pauli::identity()),
            (-1.0, Pauli::new((3, 0))),
            (-1.0, Pauli::new((0, 3))),
    ...
    jw_check_mapping(
        &[(4.0, Fermions::try_from((0, 63, 63, 0)).unwrap())],
        &[
            (1.0, Pauli::identity()),
            (-1.0, Pauli::new((3, 0))),
            (-1.0, Pauli::new((0, 0b11 << 62))),
    ...
    jw_check_mapping(
        &[(4.0, Fermions::try_from((32, 63, 63, 32)).unwrap())],
        &[
            (1.0, Pauli::identity()),
            (-1.0, Pauli::new((0, 3))),
            (-1.0, Pauli::new((0, 0b11 << 62))),
...
fn jw_two_elec_05() {
    ...
    jw_check_mapping(
        ...
        &[
            (1.0, Pauli::new((0b011101, 0))),
            (1.0, Pauli::new((0b101110, 0))),
            (-1.0, Pauli::new((0b011101, 0b11 << 62))),
            (-1.0, Pauli::new((0b101110, 0b11 << 62))),
        ],
    );
    ...
    jw_check_mapping(
        ...
        &[
            (1.0, Pauli::new((0, 0b011101))),
            (1.0, Pauli::new((0, 0b101110))),
            (-1.0, Pauli::new((0, 0b011101 + (0b11 << 62)))),
            (-1.0, Pauli::new((0, 0b101110 + (0b11 << 62)))),
        ],
    );
}
...
//     // this should be the same as (0,1,1,2), if that was canonically ordered
//     jw_check_mapping(
//         &[(8.0, Fermions::try_from((0, 1, 2, 1)).unwrap())],
//         &[
