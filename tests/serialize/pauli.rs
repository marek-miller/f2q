...
fn pauli_deserialize_01() {
    assert_eq!(serde_json::from_str::<PauliOp>("\"I\"").unwrap(), PauliOp::I);
    assert_eq!(serde_json::from_str::<PauliOp>("\"X\"").unwrap(), PauliOp::X);
    assert_eq!(serde_json::from_str::<PauliOp>("\"Y\"").unwrap(), PauliOp::Y);
    assert_eq!(serde_json::from_str::<PauliOp>("\"Z\"").unwrap(), PauliOp::Z);
}
